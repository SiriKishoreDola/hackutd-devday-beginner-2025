...
const CourseCard = (props) => {
  return (
    <div className="max-w-4xl mx-auto p-6 m-6 bg-white border border-gray-300 rounded-lg shadow-sm">
      ...
      <div className="inline-block">
        <span className="bg-blue-50 text-purple-700 px-3 py-1 rounded-full text-sm font-medium">
